...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className={`max-w-[200px] md:max-w-[260px] w-full h-screen border-r bg-white shadow-md px-4 md:px-6 py-10 fixed left-0 top-0 z-20 ${isOpen ? 'block' : 'hidden'} md:block`}
      >
